...
from PyQt4.QtCore import pyqtSignature, QString, QUrl, QByteArray, QSettings, QDate
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent = None):
        ...
        try:
            ...
            self.txtFrom.setDate(QDate.fromString(str(self.settings.value('StartDate').toString()) ,  'dd/MM/yyyy'))
            self.txtTo.setDate(QDate.fromString(str(self.settings.value('EndDate').toString()),  'dd/MM/yyyy'))
